      ...
      <section class="profile-grid">
        <aside class="profile-card profile-sidebar">
          <div class="avatar-card">
            <div class="avatar-illus">
              <img src="assets/admin-profile-m.png" alt="">
            </div>
        ...
        <div class="profile-main">
          <section class="info-card">
            <div class="card-head">
              <div class="title"><img src="assets/icon-person.png" alt=""><span>Personal Information</span></div>
              <button class="btn btn-light" type="button"><img src="assets/icon-edit.png" alt=""> Edit Profile</button>
            </div>
            <div class="info-grid">
          ...
          <section class="info-card">
            <div class="card-head">
              <div class="title"><img style="height: 20px; width: 20px" src="assets/icon-shield.png"
                  alt=""><span>Account Security</span></div>
            </div>

            <div class="security-panel">
              <div class="security-head">
                <div class="left"><img style="height: 22px; width: 22px" src="assets/icon-lock.png"
            ...
            <div class="security-panel">
              <div class="security-head">
                <div class="left"><img style="height: 30px; width: 30px" src="assets/icon-log.png"
